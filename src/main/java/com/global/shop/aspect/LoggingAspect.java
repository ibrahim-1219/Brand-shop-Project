package com.global.shop.aspect;
...
public class LoggingAspect {
	...
	@Pointcut(value = "execution(* com.global.shop.repository.*.*(..))")
	public void forRepositoryLog() {
	}

	@Pointcut(value = "execution(* com.global.shop.service.*.*(..))")
	public void forServiceLog() {
	}

	@Pointcut(value = "execution(* com.global.shop.controller.*.*(..))")
